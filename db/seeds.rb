...
# # If you would like to seed the user table with high ranking officers using rake db:seed instead of importing a CSV, uncomment the code below
...
# Seed the user table with random titles using rake db:seed, instead of importing a CSV, uncomment the code below
